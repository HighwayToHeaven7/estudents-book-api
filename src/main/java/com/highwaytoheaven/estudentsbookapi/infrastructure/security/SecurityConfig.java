...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.cors()
        ...
        .antMatchers(HttpMethod.GET, "/users/students/{student-uuid}/subjects/{subject-uuid}")
        .hasAuthority(PROFESSOR.toString())
        .antMatchers(HttpMethod.PATCH, "/users/students/grades/{grade-uuid}").hasAuthority(PROFESSOR.toString())
        .antMatchers(HttpMethod.POST, "/users/students/grades").hasAuthority(PROFESSOR.toString())
